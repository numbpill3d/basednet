"use strict";(()=>{var e={};e.id=993,e.ids=[993],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5900:e=>{e.exports=require("pg")},9491:e=>{e.exports=require("assert")},8709:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},2361:e=>{e.exports=require("events")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},3477:e=>{e.exports=require("querystring")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},9502:(e,r,t)=>{t.r(r),t.d(r,{headerHooks:()=>_,originalPathname:()=>y,patchFetch:()=>g,requestAsyncStorage:()=>w,routeModule:()=>m,serverHooks:()=>R,staticGenerationAsyncStorage:()=>p,staticGenerationBailout:()=>T});var s={};t.r(s),t.d(s,{GET:()=>E,POST:()=>d});var a=t(5419),i=t(9108),n=t(9678),o=t(8070),u=t(3168),l=t(2002),c=t(316);async function E(e){try{let{searchParams:r}=new URL(e.url),t=parseInt(r.get("limit")||"50"),s=parseInt(r.get("offset")||"0"),a=await u.m.list(t,s);return o.Z.json({data:a,error:null})}catch(e){return console.error("Error fetching webrings:",e),o.Z.json({error:"Failed to fetch webrings",data:null},{status:500})}}async function d(e){try{let r=await (0,l.mk)(),t=r.user?.id;if(!t)return o.Z.json({error:"Unauthorized",data:null},{status:401});let s=await e.json(),a=(0,c.s8)(c.gj,s);if(!a.success)return o.Z.json({error:a.error,data:null},{status:400});let{name:i,description:n}=a.data,E=await u.m.create(i,n,t);return await u.m.addMember(E.id,t),o.Z.json({data:E,error:null},{status:201})}catch(e){return console.error("Error creating webring:",e),o.Z.json({error:"Failed to create webring",data:null},{status:500})}}let m=new a.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/webrings/route",pathname:"/api/webrings",filename:"route",bundlePath:"app/api/webrings/route"},resolvedPagePath:"/workspaces/basednet/src/app/api/webrings/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:w,staticGenerationAsyncStorage:p,serverHooks:R,headerHooks:_,staticGenerationBailout:T}=m,y="/api/webrings/route";function g(){return(0,n.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:p})}},3783:(e,r,t)=>{t.d(r,{Z:()=>s});let s=new(t(5900)).Pool({user:process.env.POSTGRES_USER,password:process.env.POSTGRES_PASSWORD,host:process.env.POSTGRES_HOST,port:parseInt(process.env.POSTGRES_PORT||"5432"),database:process.env.POSTGRES_DB,ssl:{rejectUnauthorized:!1}})},5566:(e,r,t)=>{t.d(r,{t:()=>a});var s=t(3783);class a{static async create(e,r){let t=["user_id",...Object.keys(r)],a=[e,...Object.values(r)],i=t.map((e,r)=>`$${r+1}`).join(", "),n=`
