"use strict";(()=>{var e={};e.id=30,e.ids=[30],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5900:e=>{e.exports=require("pg")},9491:e=>{e.exports=require("assert")},8709:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},2361:e=>{e.exports=require("events")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},3477:e=>{e.exports=require("querystring")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},2350:(e,r,t)=>{t.r(r),t.d(r,{headerHooks:()=>p,originalPathname:()=>y,patchFetch:()=>_,requestAsyncStorage:()=>w,routeModule:()=>c,serverHooks:()=>R,staticGenerationAsyncStorage:()=>m,staticGenerationBailout:()=>T});var s={};t.r(s),t.d(s,{DELETE:()=>d,GET:()=>l});var a=t(5419),i=t(9108),n=t(9678),u=t(8070),o=t(3168),E=t(2002);async function l(e,{params:r}){try{let e=parseInt(r.id);if(isNaN(e))return u.Z.json({error:"Invalid webring ID",data:null},{status:400});let t=await o.m.findById(e);if(!t)return u.Z.json({error:"Webring not found",data:null},{status:404});let s=await o.m.getMembers(e);return u.Z.json({data:{...t,members:s},error:null})}catch(e){return console.error("Error fetching webring:",e),u.Z.json({error:"Failed to fetch webring",data:null},{status:500})}}async function d(e,{params:r}){try{let e=await (0,E.mk)(),t=e.user?.id;if(!t)return u.Z.json({error:"Unauthorized",data:null},{status:401});let s=parseInt(r.id);if(isNaN(s))return u.Z.json({error:"Invalid webring ID",data:null},{status:400});let a=await o.m.findById(s);if(!a)return u.Z.json({error:"Webring not found",data:null},{status:404});if(a.creator_id!==t)return u.Z.json({error:"Forbidden - only the creator can delete this webring",data:null},{status:403});return await o.m.delete(s),u.Z.json({data:{message:"Webring deleted successfully"},error:null})}catch(e){return console.error("Error deleting webring:",e),u.Z.json({error:"Failed to delete webring",data:null},{status:500})}}let c=new a.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/webrings/[id]/route",pathname:"/api/webrings/[id]",filename:"route",bundlePath:"app/api/webrings/[id]/route"},resolvedPagePath:"/workspaces/basednet/src/app/api/webrings/[id]/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:w,staticGenerationAsyncStorage:m,serverHooks:R,headerHooks:p,staticGenerationBailout:T}=c,y="/api/webrings/[id]/route";function _(){return(0,n.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:m})}},3783:(e,r,t)=>{t.d(r,{Z:()=>s});let s=new(t(5900)).Pool({user:process.env.POSTGRES_USER,password:process.env.POSTGRES_PASSWORD,host:process.env.POSTGRES_HOST,port:parseInt(process.env.POSTGRES_PORT||"5432"),database:process.env.POSTGRES_DB,ssl:{rejectUnauthorized:!1}})},5566:(e,r,t)=>{t.d(r,{t:()=>a});var s=t(3783);class a{static async create(e,r){let t=["user_id",...Object.keys(r)],a=[e,...Object.values(r)],i=t.map((e,r)=>`$${r+1}`).join(", "),n=`
