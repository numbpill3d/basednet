"use strict";(()=>{var e={};e.id=508,e.ids=[508],e.modules={2934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},4580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},5869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5900:e=>{e.exports=require("pg")},9491:e=>{e.exports=require("assert")},8709:e=>{e.exports=require("buffer")},6113:e=>{e.exports=require("crypto")},2361:e=>{e.exports=require("events")},3685:e=>{e.exports=require("http")},5687:e=>{e.exports=require("https")},3477:e=>{e.exports=require("querystring")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},5781:(e,t,r)=>{r.r(t),r.d(t,{headerHooks:()=>T,originalPathname:()=>S,patchFetch:()=>m,requestAsyncStorage:()=>y,routeModule:()=>p,serverHooks:()=>R,staticGenerationAsyncStorage:()=>w,staticGenerationBailout:()=>f});var s={};r.r(s),r.d(s,{DELETE:()=>E,GET:()=>l,PATCH:()=>d});var n=r(5419),a=r(9108),i=r(9678),o=r(8070),u=r(2002),c=r(6707);async function l(e,{params:t}){try{let{cid:e}=t,r=await c.Q.findByCid(e);if(!r)return o.Z.json({error:"Content not found"},{status:404});return o.Z.json({content:r})}catch(e){return console.error("Error fetching IPFS content:",e),o.Z.json({error:"Failed to fetch IPFS content"},{status:500})}}async function d(e,{params:t}){try{let r=await (0,u.ts)();if(!r)return o.Z.json({error:"Unauthorized"},{status:401});let{cid:s}=t,{pinned:n}=await e.json();if(void 0===n)return o.Z.json({error:"No valid update fields provided"},{status:400});let a=await c.Q.findByCid(s);if(!a)return o.Z.json({error:"Content not found"},{status:404});if(!await (0,u.Fs)(r.id,a.user_id))return o.Z.json({error:"Forbidden"},{status:403});let i=await c.Q.setPinStatus(s,n);return o.Z.json({content:i})}catch(e){return console.error("Error updating IPFS content:",e),o.Z.json({error:"Failed to update IPFS content"},{status:500})}}async function E(e,{params:t}){try{let e=await (0,u.ts)();if(!e)return o.Z.json({error:"Unauthorized"},{status:401});let{cid:r}=t,s=await c.Q.findByCid(r);if(!s)return o.Z.json({error:"Content not found"},{status:404});if(!await (0,u.Fs)(e.id,s.user_id))return o.Z.json({error:"Forbidden"},{status:403});if(!await c.Q.delete(r,e.id))return o.Z.json({error:"Failed to delete content"},{status:500});return o.Z.json({success:!0})}catch(e){return console.error("Error deleting IPFS content:",e),o.Z.json({error:"Failed to delete IPFS content"},{status:500})}}let p=new n.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/ipfs/[cid]/route",pathname:"/api/ipfs/[cid]",filename:"route",bundlePath:"app/api/ipfs/[cid]/route"},resolvedPagePath:"C:\\Users\\adoni\\Desktop\\projects\\basednet\\src\\app\\api\\ipfs\\[cid]\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:y,staticGenerationAsyncStorage:w,serverHooks:R,headerHooks:T,staticGenerationBailout:f}=p,S="/api/ipfs/[cid]/route";function m(){return(0,i.patchFetch)({serverHooks:R,staticGenerationAsyncStorage:w})}},3783:(e,t,r)=>{r.d(t,{Z:()=>s});let s=new(r(5900)).Pool({user:process.env.POSTGRES_USER,password:process.env.POSTGRES_PASSWORD,host:process.env.POSTGRES_HOST,port:parseInt(process.env.POSTGRES_PORT||"5432"),database:process.env.POSTGRES_DB,ssl:{rejectUnauthorized:!1}})},6707:(e,t,r)=>{r.d(t,{Q:()=>n});var s=r(3783);class n{static async create(e,t,r,n,a){let i=`
    ...
    `;return(await s.Z.query(t,[e])).rows}static async getContentStats(e){let t=`
      ...
      FROM ipfs_content 
      WHERE user_id = $1
    `,r=await s.Z.query(t,[e]);return{total:parseInt(r.rows[0].total),pinned:parseInt(r.rows[0].pinned),totalSize:parseInt(r.rows[0].total_size)}}}},5566:(e,t,r)=>{r.d(t,{t:()=>n});var s=r(3783);class n{static async create(e,t){let r=["user_id",...Object.keys(t)],n=[e,...Object.values(t)],a=r.map((e,t)=>`$${t+1}`).join(", "),i=`
    ...
    `;return(await s.Z.query(o,[e,...i])).rows[0]||null}static async delete(e){let t=await s.Z.query("DELETE FROM profiles WHERE user_id = $1 RETURNING id",[e]);return null!==t.rowCount&&t.rowCount>0}static async getTheme(e){let t=await s.Z.query("SELECT theme_preferences FROM profiles WHERE user_id = $1",[e]);return t.rows[0]?.theme_preferences||null}static async updateTheme(e,t){let r=`
      ...
      WHERE user_id = $1
    `,n=await s.Z.query(r,[e,JSON.stringify(t)]);return null!==n.rowCount&&n.rowCount>0}}},4111:(e,t,r)=>{r.d(t,{T:()=>n});var s=r(3783);class n{static async create(e,t,r){let n=`
    ...
    `;return(await s.Z.query(n,[e,t,r])).rows[0]}static async findById(e){return(await s.Z.query("SELECT * FROM users WHERE id = $1",[e])).rows[0]||null}static async findByUsername(e){return(await s.Z.query("SELECT * FROM users WHERE username = $1",[e])).rows[0]||null}static async update(e,t){let r=["username","email","auth_domain"],n=Object.keys(t).filter(e=>r.includes(e));if(0===n.length)return null;let a=n.map((e,t)=>`${e} = $${t+2}`).join(", "),i=n.map(e=>t[e]),o=`
      ...
      WHERE id = $1 
      RETURNING *
    `;return(await s.Z.query(o,[e,...i])).rows[0]||null}static async delete(e){return((await s.Z.query("DELETE FROM users WHERE id = $1 RETURNING id",[e])).rowCount??0)>0}static async list(e=10,t=0){return(await s.Z.query("SELECT * FROM users ORDER BY created_at DESC LIMIT $1 OFFSET $2",[e,t])).rows}}},874:(e,t,r)=>{r.d(t,{L:()=>i});var s=r(5900);if(!process.env.DATABASE_URL)throw Error("DATABASE_URL is not defined");let n=new s.Pool({connectionString:process.env.DATABASE_URL,max:20,idleTimeoutMillis:3e4,connectionTimeoutMillis:2e3});async function a(e){let t=await n.connect();try{await t.query("BEGIN");let r=await e(t);return await t.query("COMMIT"),r}catch(e){throw await t.query("ROLLBACK"),e}finally{t.release()}}n.query("SELECT NOW()",e=>{e?console.error("Database connection error:",e.message):console.log("Database connected successfully")}),process.on("SIGTERM",async()=>{console.log("Closing database pool"),await n.end()});let i={providers:[(0,r(6485).Z)({name:"IndieAuth",credentials:{username:{label:"Username",type:"text"},password:{label:"Password",type:"password"}},authorize:async e=>e?.username?{id:"1",name:e.username,email:`${e.username}@example.com`}:null})],callbacks:{async session({session:e,token:t}){try{if(e.user)return await a(async t=>{let r=await t.query("SELECT * FROM users WHERE email = $1",[e.user?.email]);return r.rows[0]?{...e,user:{...e.user,id:r.rows[0].id,username:r.rows[0].username}}:e});return e}catch(t){return console.error("Error getting session:",t),e}},jwt:async({token:e,user:t})=>(t&&(e.id=t.id),e)},pages:{signIn:"/auth/signin",error:"/auth/error"},debug:!1,session:{strategy:"jwt"}}},2002:(e,t,r)=>{r.d(t,{Fs:()=>o,mk:()=>u,ts:()=>i});var s=r(9605),n=r(874),a=r(4111);async function i(){let e=await (0,s.Z1)(n.L);return e?.user?.id?await a.T.findById(e.user.id):null}async function o(e,t){return e===t}async function u(){let e=await (0,s.Z1)(n.L);if(!e?.user?.id)throw Error("Authentication required");return e}r(5566)}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),s=t.X(0,[638,938,70],()=>r(5781));module.exports=s})();